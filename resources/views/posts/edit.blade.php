...
@section('content')
    ...
    @else
    <form  id="control" action="{{route('posts.update',$post->id)}}" name="form" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{method_field('PUT')}}
        <input type="hidden" name="user_id" value="{{Auth::id()}}"/>
        <div class=" container container-fixed-lgu">
                                        ...
                                        <div class="col-md-9 col-middle sm-padding-15 align-items-center d-flex">
                                            <div>
                                                <div class="form-group m-b-10">
                                                    <input type="text" value="{{$post->title}}" name="title" class="form-control input-lg" required>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="padding-30 sm-padding-5">
                                    ...
                                    <div class="row b-a b-grey no-margin" style="border: none">
                                        ...
                                        <div class="col-md-9 col-middle sm-padding-15 align-items-center d-flex">
                                            <div>
                                                <div class="form-group m-b-10">
                                                    <input type="text" value="{{$post->category}}" name="category" class="form-control input-lg" required>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="padding-30 sm-padding-5">
                                    <div class="card-block no-scroll no-padding">
                                        <div class="dropzone no-margin">
                                            <div class="fallback">
                                                <input name="image" type="file" value="{{$post->image}}"required/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
